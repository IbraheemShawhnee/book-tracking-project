					...
					return (
						...
						>
							...
							<div className="w-11 h-11 sm:w-12 sm:h-12 shrink-0">
								...
								{authorized ? (
									<button
										className="  bg-gray-700 hover:block items-center justify-center"
...
// 	return (
// 		<div>
// 			<Typography className="pl-6 mb-2">{title}</Typography>
// 			<div>
// 				{filtered.map((book) => {
// 					return (
// 						<div
...
// 							)}
// 							{book.rating ? (
// 								<Typography variant="body1" className="whitespace-nowrap ml-1">
// 									<span className="hidden sm:inline-block mr-1">Rating:</span>
// 									<span>{book.rating}/10</span>
// 								</Typography>
// 							) : (
